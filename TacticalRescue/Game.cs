...
namespace test_roguelike
{
    public static class Game
    {
        ...
        private static readonly int _screenWidth = 240;
        private static readonly int _screenHeight = 130;
        public static RLRootConsole _rootConsole;

        // The map console takes up most of the screen and is where the map will be drawn
        private static readonly int _mapWidth = 180;
        private static readonly int _mapHeight = 115;
        ...
        private static readonly int _messageHeight = 65;
        ...
        private static readonly int _commandWidth = 100;
        ...
        public static void Main()
        {
            ...
            _rootConsole = new RLRootConsole(fontFileName, _screenWidth, _screenHeight, 16, 16, 1f, consoleTitle);
